...
# 🦁 XXD Panel 063｜دفتر الاستعارة البكسلية
...
عند محاولة منح الصورة إحساساً رقمياً ومعنى تجريدياً، يسهل الانزلاق إلى شاشة ممتلئة بالبكسلات ووهج النيون ومؤثرات glitch الزخرفية؛ يكون الأثر قوياً، لكن الموضوع والاستعارة يضيعان وسط الضجيج. والنتيجة الشائعة الأخرى هي وضع الصورة داخل قناع مربع من دون إعادة تنظيم حقيقية للمساحة.

يبحث **Panel 063** أولاً عن محيط أساسي أو مساحة سالبة مستمدة من الصورة الأصلية، ويحوّلها إلى Pixel Mask رئيسي، ثم يوزع العناصر والحركات والبيئة المهمة داخل حدوده وخارجها. يخدم الانزياح الخفيف الإيقاع فقط، بينما تجعل لوحة الألوان الناعمة والمحدودة والمساحات الفارغة الواسعة الاستعارة قابلة للرؤية.

### استخدمه في هذه الحالات

- **عندما تحتاج إلى إحساس رقمي من دون ملصق cyber-glitch:** تخدم لغة البكسل الموضوع والاستعارة، ولا تعتمد على الضجيج لفرض حضورها.
- **عندما تريد أن تبقى الصورة التجريدية قابلة للقراءة:** ينظم Mask مركزي واحد الهوية والحركة والبيئة وعلاقات المساحة السالبة.
- **عندما تحب التخطيط التجريبي المنضبط:** تصنع الحواف المتدرجة والانزياحات والانقطاعات الموضعية الإيقاع فقط، وتحافظ الألوان الناعمة والخلفية شبه البيضاء على مساحة التنفس.
...
> استخدم XXD Panel 063 لهذه الصورة، واقترح أولاً أنسب تكوين ومقاس.
...
## تحقق سريع: هل XXD Panel 063 مناسب لك؟

| ما الذي يهمك؟ | ما الذي يقدمه هذا الأسلوب؟ |
|---|---|
| **النتيجة التي ستحصل عليها** | إعادة بناء الصور باستخدام أقنعة البكسل وبقع الألوان الناعمة والاستعارات السلبية |
| **السمات التي تُعرف من النظرة الأولى** | قناع البكسل · مجموعة الألوان المجمعة · التداخل السلبي · خلل بسيط · مساحة كبيرة من المساحة البيضاء |
...
فهو يعثر على الشكل الكبير أو الشكل السلبي أو الشكل الرمزي الذي لا يُنسى للمصدر ويحوله إلى قناع بكسل مركزي. يتم ضغط الكائنات الأساسية والإجراءات والقرائن البيئية في عدد قليل من كتل البكسل التي تتداخل وتتداخل وتردد صدى عبر هذا القناع.

```text
العثور على الكفاف الأساسي أو الشكل السلبي ← إنشاء قناع بكسل أساسي واحد ← ضغط الكائنات والإجراءات في كتل بكسل يمكن التعرف عليها ← إنشاء استعارة من خلال التداخل والانسداد والإزاحة ← اشتقاق لوحة محدودة ناعمة من المصدر ← التحكم في التسلسل الهرمي بمساحة سلبية سخية
```

## السمات التي تميّز الأسلوب النهائي

- يعمل قناع مركزي واحد كحاوية مرئية، مع وجود عدد قليل من أشكال البكسل التي تنشئ تسلسلًا هرميًا واضحًا حوله.
- تحافظ الحواف المتدرجة والوحدات المربعة ومستويات الألوان المبسطة على نسب الموضوع ووضعيته وميزات التعريف.
- يبقى الخلل عبارة عن إيقاع مقيد - تحولات صغيرة، أو فواصل، أو كتل مفقودة - وليس جماليًا على الإطلاق بسبب الفشل السيبراني.
- تظل اللوحة المحدودة ناعمة وشفافة، مع وجود عدد قليل من الألوان المصدرية كلكنات على أرضية شبه بيضاء.
- قد يختبئ النص في مساحة سلبية، أو يتبع حافة القناع، أو يتم مقاطعته محليًا بواسطة وحدات البكسل حتى يشارك في الاستعارة.

توجد القيود الجمالية وقواعد الرفض فقط في [الموجّه الصيني الأصلي](references/original-prompt/zh-CN.md)، بينما يتولى الـ Skill ومهايئ التشغيل متغيرات التسليم فقط. [سير عمل Skill](SKILL.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-063-prompt.en.md)
...
عند تمرير مجلد صور مباشرةً، تعالجه مهارة الجندي دفعةً واحدة بالجمالية الأصلية نفسها لـ Panel 063. تفحص المهارة صيغ الصور النقطية الشائعة تكرارياً، وتعلن العدد، ثم تحسم النمط والحجم والنص واللغة مرة واحدة. تُولَّد كل صورة باستقلال من دون تسرب المحتوى أو النص بين العناصر، وتبقى الدفعة كلها داخل مجلد مهمة مسطح واحد. يُسجَّل فشل أي عنصر من دون إسقاط الصور اللاحقة بصمت.
...
/xxd-panel-063 photo.jpg --mode top-bottom --size auto --text prompt --locale ar-SA
...
/xxd-panel-063 photo.jpg --mode design-only --size 9:16 --text prompt --locale ar-SA
...
/xxd-panel-063 photo.jpg --mode design-only --size 3:4 --copy "دع الضوء يبقى هنا" --locale ar-SA

# نمطان × ثلاثة أحجام ينتجان ستة تكوينات كاملة مستقلة
/xxd-panel-063 photo.jpg --mode top-bottom,design-only --size 1:1,3:4,9:16 --text prompt --locale ar-SA

# تطبيق Panel 063 على مجلد كامل مع حسم الإعدادات المشتركة مرة واحدة
/xxd-panel-063 "/path/to/photos" --mode design-only --size auto,9:16 --text prompt --locale ar-SA
...
يمكن لمستخدمي Claude Code ربط المجلد نفسه بالمسار: `~/.claude/skills/xxd-panel-063`. أعد تشغيل جلسة الوكيل بعد التثبيت.
...
المواصفات الكاملة: [مسار عمل المهارة](SKILL.md) · [أرشيف الأسلوب الأصلي](references/original-prompt/zh-CN.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-063-prompt.en.md) · [مهايئ التشغيل الصيني](references/xxd-panel-063-prompt.zh-CN.md)
...
| **[xxd-panel-063](https://github.com/nevertoday/xxd-panel-063)** | شكل أسود رئيسي · فراغ هائل · تلاشي هالف تون · تأمل زِنّي · شظايا فكر |
...
| **الجنود** | `xxd-panel-NNN` (حالياً 001–063) | تنفذ كل مهارة مرقمة موجّهها الأصلي وجماليتها الخاصة فقط، وتنجز المهمة الفردية التي يرسلها الجنرال. |
