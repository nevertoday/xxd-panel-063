...
لهذا الإحباط صنعت **Panel 063**. هو لا يضع قالباً فوق الصورة؛ بل يحدد أولاً ما لا يجوز فقدانه، ثم يترجمه إلى **إعادة بناء الصور باستخدام أقنعة البكسل وبقع الألوان الناعمة والاستعارات السلبية**.
