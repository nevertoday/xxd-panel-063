...
```text
/xxd-panel-063 <source-or-directory> --mode top-bottom,design-only \
...
1. 上下对照（原图在上，063 设计在下）
2. 左右对照（原图在左，063 设计在右）
...
```text
~/Desktop/xxd/xxd-panel-063/<fresh-task>/
...
- `references/xxd-panel-063-prompt.zh-CN.md`
- `references/xxd-panel-063-prompt.en.md`
